...
{
    printf("num = %d\n",num);
    char pmem_name[MAX_FILE_PATH] = "/home/cc/cctlib/tests/crush_mem.out.";
    char pcache_name[MAX_FILE_PATH] = "/home/cc/cctlib/tests/crush_cache.out.";
    char pconsistentvaribles_name[MAX_FILE_PATH] = "/home/cc/cctlib/tests/consistent_variable.out.";
    ...
    FILE *pinfo = fopen("/home/cc/cctlib/tests/malloctrace.out", "r+");
