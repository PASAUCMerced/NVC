...
compwhite        = 
configdir        = config
configpath       = /home/cc/recompute/specOMP_install/config/dave.cfg
copies           = 1
current_range    = 
datadir          = data
default_size     = ref
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/cc/recompute/specOMP_install/result/OMP2012.505.log
lognum           = 505
mach             = default
mail_reports     = all
mailcompress     = 0
...
no_monitor       = 
note_preenv      = 0
notes_plat_sysinfo_000 =  Sysinfo program /home/cc/recompute/specOMP_install/Docs/sysinfo
notes_plat_sysinfo_005 =  $Rev: 395 $ $Date:: 2012-07-25 \#$ 8f8c0fe9e19c658963a1e67685e50647
notes_plat_sysinfo_010 =  running on crash-test6 Sun Oct 21 20:23:04 2018
...
notes_plat_sysinfo_240 =  SPEC is set to: /home/cc/recompute/specOMP_install
notes_plat_sysinfo_245 =     Filesystem     Type  Size  Used Avail Use% Mounted on
notes_plat_sysinfo_250 =     /dev/sda1      ext4  219G   66G  144G  32% /
...
path             = /home/cc/recompute/specOMP_install/benchspec/OMP2012/359.botsspar
plain_train      = 0
platform         = 
power            = 0
preenv           = 1
...
run              = all
rundir           = run
runspec          = /home/cc/recompute/specOMP_install/bin/runspec --config=dave.cfg --action=build --tune=base 359.botsspar
safe_eval        = 1
...
srcalt           = 
srcdir           = src
srcsource        = /home/cc/recompute/specOMP_install/benchspec/OMP2012/359.botsspar/src
stagger          = 10
...
sysinfo_program  = specperl /home/cc/recompute/specOMP_install/Docs/sysinfo
table            = 1
teeout           = 0
test_date        = Oct-2018
threads          = -1
top              = /home/cc/recompute/specOMP_install
train_with       = train
tune             = base
uid              = 1000
unbuffer         = 1
