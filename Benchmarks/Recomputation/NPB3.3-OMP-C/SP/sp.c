...
//kai
int k1=0,k2=0,k3=0,k4=0,k5=0,k6=0,k7=0,k8=2,k9=0,k10=0, k11=0, k12=0, k13=0, k14=0, k15=0, k16=0;
...
//  start_crash();
  ...
  addr[count_addr++] = &ws;
  addr[count_addr++] = &qs;
  addr[count_addr++] = &rho_i;
  addr[count_addr++] = &speed;
  addr[count_addr++] = &square;
  addr[count_addr++] = &rhs;
  addr[count_addr++] = &cv;
  addr[count_addr++] = &rhon;
  addr[count_addr++] = &rhos;
  addr[count_addr++] = &rhoq;
  addr[count_addr++] = &lhs;
  addr[count_addr++] = &lhsp;
  addr[count_addr++] = &lhsm;
  addr[count_addr++] = &k1;
  addr[count_addr++] = &k2;
  addr[count_addr++] = &k3;
  addr[count_addr++] = &k4;
 ...
 for (; step <= niter+1; step++) {
    if ((step % 20) == 0 || step == 1) {
      printf(" Time step %4d\n", step);
    }
    adi();
    k1=0;k2=0;k3=0;k4=0;k5=0;k6=0;k7=0;k8=2;k9=0;k10=0; k11=0; k12=0; k13=0; k14=0; k15=0; k16=0;
  }
//kai
//  end_crash();
  timer_stop(1);
  ...
  FILE *file;
  char result_file[MAX_FILE_PATH] = "/home/cc/cctlib/tests/recompute_result.out.jie";
