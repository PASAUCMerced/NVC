...
//kai
int  k1=-1,k2=-1,k3=0,k4=0,k5=0,k6=0,k7=0,k8=2,k9=0,k10=0, k11=0, k12=0, k13=0, k14=0, k15=0;
...
int main(int argc, char *argv[])
{
  ...
  /*
	//kai
  //us = (double*)malloc(KMAX*(JMAXP+1)*(IMAXP+1));
...
// crucial_data(ce,"double", 13*5);
  ...
  addr[count_addr++] = &rhs;
  addr[count_addr++] = &ue;
  addr[count_addr++] = &fjac;
  addr[count_addr++] = &njac;
  addr[count_addr++] = &lhs;
  addr[count_addr++] = &k1;
  addr[count_addr++] = &k2;
  addr[count_addr++] = &k3;
  ...
  for (; step <= niter+1; step++) {
    if ((step % 20) == 0 || step == 1) {
      printf(" Time step %4d\n", step);
   	 ...
   	 adi();
     k1=-1;k2=-1;k3=0;k4=0;k5=0;k6=0;k7=0;k8=2;k9=0;k10=0; k11=0; k12=0; k13=0; k14=0; k15=0;
  }
	//end_crash();
  timer_stop(1);
  tmax = timer_read(1);
