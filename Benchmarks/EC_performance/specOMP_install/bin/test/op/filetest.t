...
# SPEC CPU - skip tests that change UID; we don't use these things, and failure
# of these tests can cause tools installation to fail.
if (1) {
  print "ok 6 #skipped for SPEC CPU tools\n";
  print "ok 7 #skipped for SPEC CPU tools\n";
  print "ok 8 #skipped for SPEC CPU tools\n";
} else {
