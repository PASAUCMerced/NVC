...
Furthermore, Windows testing has been very limited.  The benchmark
tools install, but there have been issues getting successful runs on
Windows. 

License information may be found in the file LICENSE.txt in the top
level directory of your SPEC OMP2012 benchmark.  Note that in some cases
programs which have been licensed to SPEC for distribution with SPEC
OMP2012 are also available separately under other licenses, such as the
...
hereby informed that all files on the SPEC OMP2012 benchmark are covered 
by SPEC's license, unless specificallly noted otherwise in the file
