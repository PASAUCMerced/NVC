...
class Domain {
   ...
   void AllocateNodePersistent(Int_t numNode) // Node-centered
   {
	...
	//kai
      crucial_data(&m_x[0], "double", numNode);
      crucial_data(&m_y[0], "double", numNode);
      crucial_data(&m_z[0], "double", numNode);
      crucial_data(&m_xd[0], "double", numNode);
      crucial_data(&m_yd[0], "double", numNode);
      crucial_data(&m_zd[0], "double", numNode);
      crucial_data(&m_xdd[0], "double", numNode);
      printf("xdd = %d\n", numNode);
      crucial_data(&m_ydd[0], "double", numNode);
      crucial_data(&m_zdd[0], "double", numNode);
      crucial_data(&m_fx[0], "double", numNode);
      crucial_data(&m_fy[0], "double", numNode);
      crucial_data(&m_fz[0], "double", numNode);
      crucial_data(&m_nodalMass[0], "double", numNode);
...
//kai
	crucial_data(&m_nodelist[0], "int", 8*numElem);
        crucial_data(&m_lxim[0], "int", numElem);
        crucial_data(&m_lxip[0], "int", numElem);
        crucial_data(&m_letam[0], "int", numElem);
        crucial_data(&m_letap[0], "int", numElem);
        crucial_data(&m_lzetam[0], "int", numElem);
        crucial_data(&m_lzetap[0], "int", numElem);
        crucial_data(&m_elemBC[0], "int", numElem);

        crucial_data(&m_e[0], "double", numElem);
	crucial_data(&m_p[0], "double", numElem);
        crucial_data(&m_q[0], "double", numElem);
        crucial_data(&m_ql[0], "double", numElem);
        crucial_data(&m_qq[0], "double", numElem);
        crucial_data(&m_v[0], "double", numElem);
        crucial_data(&m_volo[0], "double", numElem);
        crucial_data(&m_delv[0], "double", numElem);
        crucial_data(&m_vdov[0], "double", numElem);
        crucial_data(&m_arealg[0], "double", numElem);
        crucial_data(&m_ss[0], "double", numElem);
        crucial_data(&m_elemMass[0], "double", numElem);
        crucial_data(&m_vnew[0], "double", numElem);
