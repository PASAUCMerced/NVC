...
#  All Rights Reserved
#
# $Id: CPUFlagsParser.pm 1164 2011-08-19 19:20:01Z CloyceS $
  ...
  if ($elem eq 'flagsdescription') {    # Top-level container
    ...
    if (defined($self->{'currelem'})
        ...
        die "Saw <flagsdescription> before finishing previous processing!\n";
           ...
           || $elem eq 'style'
           || $elem eq 'header'
           || $elem eq 'platform_settings'	# CPU2006 <= v1.1,MPI2007
           || $elem eq 'submit_command'		# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'fdo_settings'		# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'sw_environment'		# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'os_tuning'		# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'virtual_machine'	# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'firmware'		# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'parts'			# CPU2006 >= v1.2,OMP2012,CPUv6
           || $elem eq 'filename'
           || $elem eq 'dumpit'
           ) {
